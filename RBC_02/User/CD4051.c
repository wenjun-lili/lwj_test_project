...
void CD4051_Init(void)
{
    ...
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_3;  // INH INA  INB RBCS-02只剩下3脚
...
//		      GPIO_ResetBits(GPIOG,GPIO_Pin_3 | GPIO_Pin_4);// INA INB =00
        GPIO_ResetBits(GPIOG,GPIO_Pin_3);//20180321
        break;
...
//		      GPIO_SetBits(GPIOG,GPIO_Pin_3 | GPIO_Pin_4);// INA INB =00
        GPIO_SetBits(GPIOG,GPIO_Pin_3);//20180321
        break;
    default:
        break;
    }
